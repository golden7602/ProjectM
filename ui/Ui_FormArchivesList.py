...
# Form implementation generated from reading ui file 'e:\ProjectM\Ui\FormArchivesList.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.searchByProject = QtWidgets.QPushButton(Form)
        self.searchByProject.setObjectName("searchByProject")
        self.horizontalLayout_2.addWidget(self.searchByProject)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-size:11pt;\">可输入关键字在多个字段中快速查询，多值字段不包含在内，请使用标准方法查询</span></p></body></html>"))
        self.searchByProject.setText(_translate("Form", "按关联项目查询"))
